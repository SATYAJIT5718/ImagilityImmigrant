...
const CertificationsListView = props => {
  ...
  const deleteHandler = async id => {
    ...
    setStatus(true);
    await props
      .deleteCertificateData(authToken, beneficiaryId, professionalId, type)
      .then(res => {
        props
      ...
      <>
          ...
          <View style={styles.body}>
            <View
              style={{
                ...
                marginLeft: beneficiaryMOC ? scale(10) : scale(60),
              }}>
            ...
            <View
              style={{
                ...
                marginLeft: beneficiaryMOC ? 0 : scale(-60),
              }}>
              <Text style={styles.formInputTitle}>Organization</Text>
            </View>
            {beneficiaryMOC ? (
              <View
                style={{
        ...
        <View
          ...
          <LifeCycleAccordion
            ...
            data={renderCertificateItem(item)}
            style={{
            ...
            edit={() =>
              navigation.navigate('CertificationsDetails', {
                item: item,
                edit: true,
              })
            }
...
const mapDispatchToProps = {
  deleteCertificateData: (authToken, beneficiaryId, professionalId, type) =>
    deleteCertificateInfo(authToken, beneficiaryId, professionalId, type),
  getCertificationsData: (authToken, beneficiaryId, familyId) =>
