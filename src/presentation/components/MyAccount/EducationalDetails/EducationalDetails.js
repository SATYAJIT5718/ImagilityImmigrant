...
const EducationalDetails = props => {
  ...
  const formSubmitHandler = async formData => {
    ...
    await props
      .sendEducationData(token, payload, beneficiaryId, familyId)
      .then(res => {
        ...
        props
          ...
          .then(res => {
            setStatus(false);
            console.log('getEducationData res', res);
          })
          .catch(error => {
            setStatus(false);
            console.log('getEducationData-error', error);
          });
...
const mapDispatchToProps = {
  sendEducationData: (authToken, payload, beneficiaryId, familyId) =>
    sendEducationInfo(authToken, payload, beneficiaryId, familyId),
