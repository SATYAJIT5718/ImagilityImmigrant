...
const Immigration = props => {
  ...
  const formSubmitHandler = async formData => {
    ...
    setLoading(true);
    props
      .updateImmigratation(token, beneficiaryID, payload, familyId)
      .then(async res => {
        ...
        props
          .fetchImmigratation(token, beneficiaryID, familyId)
          .then(async res => {
            setLoading(false);
...
const mapStateToProps = ({
  sponsorDetailsReducer: {immigratationList},
...
const mapDispatchToProps = {
  updateImmigratation: (token, beneficiaryId, payload, familyId) =>
    updateImmigratationSelf(token, beneficiaryId, payload, familyId),
  fetchImmigratation: (token, beneficiaryId, familyId) =>
