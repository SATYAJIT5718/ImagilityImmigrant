...
const RelatedDocument = (props) => {
  ...
  console.log(
    props.getImmiDocType,
    "getImmiDocTypegetImmiDocTypegetImmiDocTypegetImmiDocType"
  );
        ...
        uri
          ? RNFS.readFile(uri, "base64").then(async (base64data) => {
              ...
              if (responseJson.status === 200) {
                ...
                props
                  .getImmigratation(authToken, beneficiaryId)
                  .then((res) => {
                    setStatus(false);
                  })
                  .catch((e) => {
...
const mapStateToProps = ({
  studentReducer: { immigratationList, getImmiDocType },
}) => ({
  immigratationList,
  getImmiDocType,
});
