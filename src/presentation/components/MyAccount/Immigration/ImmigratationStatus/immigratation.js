...
const ImmigrationVisa = props => {
  ...
  const immigrantVisaHandler = async formData => {
    ...
    await props
      .sendImmigrationData(token, beneficiaryId, payload, familyId)
      .then(res => {
                  ...
                  <>
                    <View
                      ...
                      {touched.alienRegNo && errors.alienRegNo && (
                        <Text style={{color: 'red'}}>{errors.alienRegNo}</Text>
                      )}
                    </View>
                    <View
                      style={{
...
const mapStateToProps = ({
  sponsorDetailsReducer: {immigratationStatus},
...
const mapDispatchToProps = {
  sendImmigrationData: (authToken, beneficiaryId, payload, familyId) =>
    updateImmigratationStatus(authToken, beneficiaryId, payload, familyId),
